...
from vaspin.types import FloatArray, PathType, StrArray
...
def read_poscar(posfile: PathType) -> dict[str, Any]:
...
def poscar_to_json(filepath: PathType) -> str:
...
def phonon_to_json(filepath: PathType) -> str:
...
def read_incar(incarfile: PathType) -> dict[str, Any]:
...
def incar_to_json(filepath: PathType) -> str:
...
def write_incar(
    tags: list[Tag], directory: PathType = ".", name: str = "INCAR"
) -> None:
